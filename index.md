...
6. **[Phase-2 Project Proposal](docs/projektantrag_p2.md)** — Phase 2 Projektantrag draft v0.2: two consensus-rule redesigns (α-rule, λ-rule) on the topological pooling-limit baseline, with new metrology-anchored scenarios S9 (fibre chain) and S10 (hub-and-spoke). **Pending v1.0 freeze**; no WP work has started.
