...
1. **[WP1 Tutorial](docs/wp1_tutorial.md)** — walkthrough of IC definition, calibration, and classification with outputs ([run it yourself](notebooks/wp1_tutorial.ipynb) | [![Binder](https://mybinder.org/badge_logo.svg)](https://mybinder.org/v2/gh/threehouse-plus-ec/admec-clock-consensus/main?labpath=notebooks%2Fwp1_tutorial.ipynb))
