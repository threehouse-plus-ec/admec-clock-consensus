...
**Status:** WP1 complete. WP2 complete. **DG-2 NOT MET. DG-2b NOT MET. DG-3 NOT MET on the "three-way > two-way" clause** (negative results, as anticipated). WP3 ablations 1, 2, 3, 4 of 5 complete: combined design tuning (stale + `var_loose` + lower IC threshold) closes most of the WP2 admec_full MSE gap on S1/S2 but cannot close the S3 ~8× information-theoretic gap to centralised baselines. The three-way/two-way distinction is architecturally impossible to separate at the consensus stage (max delta = 0 across 360 cells, entry 010). See [WP2 summary](logbook/wp2-summary.md), entries [008](logbook/008_2026-05-04_wp3-ablation-delay-convention.md), [009](logbook/009_2026-05-04_wp3-ablation-constraint-sensitivity.md), [010](logbook/010_2026-05-04_wp3-ablation-two-vs-three-way.md), [011](logbook/011_2026-05-05_wp3-ablation-threshold-sweep.md).
